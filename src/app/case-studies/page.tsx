  ...
  return (
    <main className="bg-white">
          ...
          <div className="flex w-full flex-col overflow-hidden rounded-[26px] bg-linear-to-r from-[#eeeeee] via-[#f4f4f4] to-[#d7d4ff] px-6 py-7 lg:flex-row lg:items-center lg:px-8">
            ...
            <div className="flex w-full justify-center lg:w-[52%] lg:justify-start">
              <Image
                ...
                width={560}
                height={350}
                className="lg:h-auto w-full h-[350px] lg:max-w-[540px] rounded-md object-cover lg:object-contain"
                priority
              />
            </div>

            {/* RIGHT CONTENT */}
            <div className="mt-8 w-full lg:mt-0 lg:w-[48%] lg:pl-7">
              <h2 className="lg:max-w-[460px] text-[28px] font-bold leading-[1.05] text-[#2417ff] sm:text-[34px]">
                24/7 Digital Veterinary Care Platform
              </h2>

              <p className="mt-4 lg:max-w-[520px] text-[12px] leading-[1.35] text-[#2f2f2f]">
              ...
              <div className="mt-4">
                ...
                <p className="mt-1 lg:max-w-[520px] text-[12px] leading-[1.35] text-[#2f2f2f]">
              ...
              <button
                type="button"
                className="mt-5 rounded-md bg-[#2417ff] px-5 py-2.5 text-[12px] font-semibold text-white transition hover:bg-[#1208d8]"
              >
                View Case Study
              </button>
            </div>
      ...
      <section className="bg-white py-8">
        <div className="mx-auto w-full max-w-6xl px-8 sm:px-14">
          <div className="flex w-full flex-col overflow-hidden rounded-[24px] bg-linear-to-r from-[#eeeeee] via-[#eeeeee] to-[#d9d5ff] px-7 py-7 lg:flex-row lg:items-center lg:px-8">

            {/* LEFT CONTENT */}
            <div className="w-full lg:w-[50%]">
              <h2 className="lg:max-w-[430px] text-[30px] font-bold leading-[1.1] text-[#2417ff] sm:text-[36px]">
                Online Pet Pharmacy Platform
              </h2>

              <p className="mt-4 lg:max-w-[520px] text-[11px] leading-[1.4] text-[#2f2f2f]">
              ...
              <div className="mt-4">
                ...
                <p className="mt-1 lg:max-w-[520px] text-[11px] leading-[1.4] text-[#2f2f2f]">
              ...
              <button
                type="button"
                className="mt-6 rounded-md bg-[#2417ff] px-5 py-2.5 text-[11px] font-semibold text-white transition hover:bg-[#1208d8]"
              >
                View Case Study
              </button>
            </div>
      ...
      <section className="bg-white py-8">
        <div className="mx-auto w-full lg:max-w-6xl px-8 sm:px-14">
          <div className="flex w-full flex-col overflow-hidden rounded-[24px] bg-[#eeeeee] px-5 py-5 lg:flex-row lg:items-center lg:px-6">
            ...
            {/* RIGHT CONTENT */}
            <div className="mt-8 w-full lg:mt-0 lg:w-[50%] lg:pl-10">
              <h2 className="lg:max-w-[520px] text-[28px] font-bold leading-[1.08] text-[#2417ff] sm:text-[34px]">
              ...
              <button
                type="button"
                className="mt-5 rounded-md bg-[#2417ff] px-5 py-2.5 text-[11px] font-semibold text-white transition hover:bg-[#1208d8]"
              >
                View Case Study
              </button>
            </div>
      ...
      <section className="bg-white py-8">
        <div className="mx-auto w-full lg:max-w-6xl px-8 sm:px-14">
          ...
          <div className="flex w-full flex-col overflow-hidden rounded-[28px] bg-linear-to-r from-[#f3f3f3] via-[#ecebff] to-[#d9d6ff] px-8 py-10 lg:flex-row lg:items-center lg:px-12">

            {/* LEFT CONTENT */}
            <div className="w-full lg:w-[48%]">
              <h2 className="lg:max-w-[420px] text-[30px] font-bold leading-[1.1] text-[#2c2cff] sm:text-[36px]">
                Shipping and Clearing Platform
              </h2>

              <p className="mt-4 lg:max-w-[460px] text-[12.5px] leading-[1.45] text-[#4a4a4a]">
              ...
              <div className="mt-5">
                ...
                <p className="mt-1 lg:max-w-[460px] text-[12.5px] leading-[1.45] text-[#4a4a4a]">
              ...
              <button className="mt-6 bg-[#2c2cff] px-5 py-2.5 text-[12px] font-semibold text-white rounded-md hover:bg-[#1a1ae6] transition">
                View Case Study
              </button>
            </div>

            {/* RIGHT IMAGE */}
            <div className="mt-10 flex w-full justify-center lg:mt-0 lg:w-[52%] lg:justify-end">
              <Image
      ...
      <section className="bg-white py-8">
        <div className="mx-auto w-full lg:max-w-6xl px-8 sm:px-14">
          <div className="flex w-full flex-col overflow-hidden rounded-[26px] bg-linear-to-r from-[#eeeeee] via-[#f4f4f4] to-[#d7d4ff] px-6 py-7 lg:flex-row lg:items-center lg:px-9">
            ...
            {/* RIGHT CONTENT */}
            <div className="mt-8 w-full lg:mt-0 lg:w-[48%] lg:pl-7">
              <h2 className="lg:max-w-[460px] text-[30px] font-bold leading-[1.1] text-[#2417ff] sm:text-[36px]">
              ...
              <button
                type="button"
                className="mt-5 bg-[#2417ff] px-5 py-2.5 text-[11px] font-semibold text-white rounded-md transition hover:bg-[#1208d8]"
              >
                View Case Study
              </button>
            </div>
